...
import { Button, Form, Popover, Row, Col } from 'antd'
                                    ...
                                    return (
                                        // <Popover key={i} placement="top" content={o['tip']}>
                                            <Button
                                                ...
                                                type={o['type']}
                                                disabled={o['disabled']}
                                                className={`buttonWrap-btn buttonWrap-btn__${o['type']} m__r--10 ${o['isDelete'] ? 'buttonWrap-btn__isDelete': ''}  `}
                                            >
